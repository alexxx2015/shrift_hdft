...
public class TestExampleAppRetransmit extends AbstractTest {
	...
	public void init() throws Exception {
		...
		init("/uc-config/uc-exampleappretransmit.config");
		// runCode = false;
	}
	...
	public void testInstrumentation() {
		try {
			...
			clazzes.add(sap.ExampleAppRetransmit.class);
			...
			for (Class<?> clazz : clazzes) {
				...
				if(obj.getClass().getName().equals("sap.ExampleAppRetransmit"))

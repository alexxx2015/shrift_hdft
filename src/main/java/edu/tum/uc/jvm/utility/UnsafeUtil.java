...
public class UnsafeUtil {
    ...
    /**
     * Resolves the given address and returns the object being stored at that address.
     * 
     * @param address
    ...
    /**
     * Replaces a given object by another one in memory. If they do not have the same size (e.g. being of different
     * type, an <code>IllegalArgumentException</code> is thrown.
     * 
     * @param oldObject
    ...
    /**
     * Shifts the given address by 3 bits to the left if compressed oops mode is on, otherwise returns the argument.
     * @param coopAddress Address before conversion.
    ...
    /**
     * Converts a given integer into a long by applying a shift and logical and operation. Used for addresses.
     ...
     * @param o The object to compute the memory size of. Must not be an array.
     ...
     * @param o The object or array to compute the memory size of.
     ...
     * @param o The array to compute the memory size of. Must not be an object other than an array.

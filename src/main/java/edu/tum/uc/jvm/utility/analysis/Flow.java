...
public class Flow {
	...
	public void addChopNode(int p_byteCodeIndex, String p_ownerMethod, String p_label, String p_operation, String p_local2vn){
	...
	public class Chop {
		...
		public Chop(int p_byteCodeIndex, String p_ownerMethod, String p_label, String p_operation, String p_local2vn, String sourceId){
